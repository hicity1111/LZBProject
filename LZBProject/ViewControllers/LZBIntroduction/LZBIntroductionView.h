...
@class LZBIntroductionView;
@protocol LZBIntroductionDataSource <NSObject>
...
@protocol LZBIntroductionDelegate <NSObject>
...
typedef void(^LZBEnterAction)(void);

@interface LZBIntroductionView : UIView

@property (nonatomic, strong) UICollectionView *introlCollectionView;
@property (nonatomic, assign) id<LZBIntroductionDelegate> delegate;
@property (nonatomic, assign) id<LZBIntroductionDataSource> dataSource;
@property (nonatomic, strong) UIPageControl *pageControl;

@property (nonatomic, assign) BOOL autoLoopPlayVideo; // default YES
@property (nonatomic, strong) UIButton *enterButton;
@property (nonatomic,   copy) LZBEnterAction enterBlock;
